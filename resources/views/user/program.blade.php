  ...
  <div class="row">
    ...
    <div class="col-lg-4">
      <div class="card">
            ...
            @endif
            <h4 class="mt-2">{{$program->title}}</h4><br>
          ...
          <div class="container mt-4">
            <div class="row">
              <div class="col-6">
                <a class="btn btn-c-warning" style="color: white" href="/detailprogram/{{$program->id}}">Detail Program</a>
              </div>
              <div class="col-6">
                <a class="btn btn-c-warning" style="color: white" href="{{route('program.edit', $program->id)}}" >Edit Program</a>
              </div>
            </div>
            <div class="row mt-4">
              <div class="col">
